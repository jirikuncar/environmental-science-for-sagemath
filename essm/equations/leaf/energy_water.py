...
class eq_Rs_enbal(Equation):
    ...
    \cite[Eq. 1]{schymanski_leaf-scale_2017}
    """
...
class eq_Rll(Equation):
    ...
    \cite[Eq. 2]{schymanski_leaf-scale_2017}
    """
...
class eq_Hl(Equation):
    ...
    \cite[Eq. 3]{schymanski_leaf-scale_2017}
    """
...
class eq_El(Equation):
    ...
    \cite[Eq. 4]{schymanski_leaf-scale_2017}
    """
...
class eq_Elmol(Equation):
    ...
    \cite[Eq. 5]{schymanski_leaf-scale_2017}
    """
...
class eq_gtw(Equation):
    ...
    \cite[Eq. 6]{schymanski_leaf-scale_2017}
    """
...
class eq_gbw(Equation):
    ...
    \cite[Eq. B1]{schymanski_leaf-scale_2017}
    """
...
class eq_gbw_hc(Equation):
    ...
    \cite[Eq. B2]{schymanski_leaf-scale_2017}
    """
...
class eq_Cwl(Equation):
    ...
    \cite[Eq. B4]{schymanski_leaf-scale_2017}
    """
...
class eq_Elmol_conv(Equation):
    ...
    \cite[Eq. B6]{schymanski_leaf-scale_2017}
    """
    
    expr = E_lmol == -(P_wa - P_wl)*g_twmol/P_a


class eq_gtwmol_gtw(eq_Elmol.definition, eq_Cwl.definition, eq_Elmol_conv.definition):
    """g_twmol as a function of g_tw, using eq_Elmol, eq_Cwl and eq_Elmol_conv."""
    
    expr = g_twmol == -(P_a*P_wl*T_a - P_a*P_wa*T_l)*g_tw/((P_wa - P_wl)*R_mol*T_a*T_l)
