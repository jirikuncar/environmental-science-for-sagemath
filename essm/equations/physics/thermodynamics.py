...
class eq_Le(Equation):
    ...
    \cite[Eq. B3]{schymanski_leaf-scale_2017}
    """
...
class eq_Cwa(Equation):
    ...
    \cite[Eq. B9]{schymanski_leaf-scale_2017}
    """
...
class eq_hc(Equation):
    ...
    \cite[Eq. B10]{schymanski_leaf-scale_2017}
    """
...
class eq_Re(Equation):
    ...
    \cite[Eq. B11]{schymanski_leaf-scale_2017}
    """
...
class eq_Nu_forced_all(Equation):
    ...
    expr = Nu == Pr**(1/3)*(-0.0370000000000000*(Re + Re_c - 1/2*abs(Re - Re_c))**(4/5) + 0.0370000000000000*Re**(4/5) + 0.664000000000000*sqrt(Re + Re_c - 1/2*abs(Re - Re_c)))
...
class eq_rhoa(eq_rhoa_Pwa_Ta.definition, eq_PN2.definition, eq_PO2.definition):
    ...
    expr = rho_a == ((M_N2*P_a - (M_N2 - M_w)*P_wa)*x_N2 + (M_O2*P_a - (M_O2 - M_w)*P_wa)*x_O2)/(R_mol*T_a*x_N2 + R_mol*T_a*x_O2)
